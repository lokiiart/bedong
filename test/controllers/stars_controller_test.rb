...
class StarsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create star" do
    assert_difference('Star.count') do
      post stars_url, params: { star: { avatar: @star.avatar, favorite: @star.favorite, intro_image: @star.intro_image, name: @star.name, score: @star.score, summart: @star.summart } }
    end
  ...
  test "should update star" do
    patch star_url(@star), params: { star: { avatar: @star.avatar, favorite: @star.favorite, intro_image: @star.intro_image, name: @star.name, score: @star.score, summart: @star.summart } }

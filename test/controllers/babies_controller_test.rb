...
class BabiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create baby" do
    assert_difference('Baby.count') do
      post babies_url, params: { baby: { avatar: @baby.avatar, banner: @baby.banner, intro: @baby.intro, name: @baby.name, price: @baby.price, star_id: @baby.star_id } }
    end
  ...
  test "should update baby" do
    patch baby_url(@baby), params: { baby: { avatar: @baby.avatar, banner: @baby.banner, intro: @baby.intro, name: @baby.name, price: @baby.price, star_id: @baby.star_id } }
